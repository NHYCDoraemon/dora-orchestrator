...
def _parse_config_file(path: Path) -> ProjectConfig:
    ...
    return ProjectConfig(
        ...
        schedule_enabled=bool(data.get("schedule_enabled") or False),
        default_executor=str(data.get("default_executor") or "claude"),
        codex_home=Path(data.get("codex_home") or "~/.codex").expanduser(),
